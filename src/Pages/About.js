    ...
    <>
      <div className="container">
        ...
        <div className="about center">
          <h1 className="mt-5 text-center">Welcome to Roomie Mate!</h1>
          <h3 className="center">
            <span>Your Perfect Match Awaits</span>
          </h3>
          <p>Are you in search of the ideal roommate to share your living space? Look no further! RoomMateConnect is your ultimate platform for effortlessly connecting with compatible roommates who share your lifestyle, preferences, and values.</p>
          <h3 className="center">
            <span>Why Choose Roomie Mate?</span>
          </h3>
          <p>Finding the right roommate can be a daunting task, but RoomMateConnect makes the process simple, efficient, and enjoyable. Our user-friendly interface and advanced matching algorithms take the stress out of roommate hunting, ensuring that you find a harmonious living arrangement that suits your needs.</p>
          <h3 className="center">
          ...
          <ol className="key-features-list">
            ...
            <li>
              ...
              <span>Rest easy knowing that all RoomMateConnect users are verified, adding an extra layer of security to your roommate search.</span>
            </li>
            <li>
              <h4>
          ...
          <p className="text-center border-box">
            <em>Join Roomie Mate today and embark on a roommate search like never before. Create your profile, browse potential matches, and discover the perfect co-living companion. Your ideal roommate is just a few clicks away!</em>
          </p>
          <h2 className="text-center">
            <em>Roomie Mate: Where Connections Make a Home.</em>
          </h2>
        </div>
        <Footer />
      </div>
